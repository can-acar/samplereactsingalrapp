...
export type LogoutPayload = { userId: string };
...
export type ILogout = (payload: LogoutPayload)=>({ type: "LOGOUT", payload: LogoutPayload })
...
export const Logout = (payload: LogoutPayload): ILogout => ({type: "LOGOUT", payload: payload})
